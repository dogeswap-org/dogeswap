describe("Add Liquidity", () => {
    it("loads the two correct tokens", () => {
        ...
        cy.get("#add-liquidity-input-tokenb .token-symbol-container").should("contain.text", "WDOGE");
    });
    ...
    it("does not crash if WDOGE is duplicated", () => {
        ...
        cy.get("#add-liquidity-input-tokena .token-symbol-container").should("contain.text", "WDOGE");
        cy.get("#add-liquidity-input-tokenb .token-symbol-container").should("not.contain.text", "WDOGE");
    });
